...
public class AuthenticaionFilter implements GlobalFilter, Ordered {
...
//        return chain.filter(exchange);
    ...
    Mono<Void> unauthenticated(ServerHttpResponse response){
        ApiResponse<Void> voidApiResponse = ApiResponse.<Void>builder()
                .code(1401)
                .message("Unauthenticated nhé fen, this is filter of apigateway")
                .build();

        String body = null;
        try {
            body = objectMapper.writeValueAsString(voidApiResponse);
